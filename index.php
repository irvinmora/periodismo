...
<body>
    ...
    <?php if ($show_migration_alert): ?>
        <div
            style="background: #fff3cd; border-bottom: 2px solid #ffc107; padding: 15px 20px; text-align: center; font-family: Arial;">
        ...
        <div class="container">
            ...
            <div class="acerca-content">
                <div class="acerca-text">
                    <h3>Alto Impacto</h3>
                    <p>Este portal informativo es un proyecto académico desarrollado por estudiantes de la carrera de
                        Ciencias Sociales con mención en Periodismo de la Universidad Técnica de Babahoyo.</p>
                    <p>Nuestro objetivo es brindar un espacio donde los futuros periodistas puedan publicar sus
                        trabajos, reportajes y noticias, desarrollando habilidades prácticas en el ámbito del periodismo
                        digital.</p>
            ...
            <div class="contacto-content">
                <div class="contacto-info">
                    ...
                    <div class="redes-sociales">
                        ...
                        <div class="social-icons">
                            <a href="https://www.facebook.com/profile.php?id=61569770924518" target="_blank"
                                rel="noopener noreferrer"><i class="fab fa-facebook-f"></i></a>
                            <a href="https://whatsapp.com/channel/0029VbCRqWF84OmGJUPN4Q1O" target="_blank"
                                rel="noopener noreferrer"><i class="fab fa-whatsapp"></i></a>
                            <a href="https://x.com/gabriela_m72601" target="_blank" rel="noopener noreferrer"><i
                ...
                <div class="contacto-form">
                    ...
                    <form id="formSuscripcion" method="POST">
                        ...
                        <div class="form-group">
                            <textarea id="comentario" name="comentario"
                                placeholder="Cuéntanos tu opinión, sugerencias o comentarios (opcional)" maxlength="500"
                                rows="5"
                                style="resize: vertical; font-family: 'Roboto', sans-serif; padding: 10px; border: 1px solid #ddd; border-radius: 4px; width: 100%;"></textarea>
                        </div>
                    ...
                    <div style="margin-top: 15px; font-size: 0.9rem; color: #666;">
                        <i class="fas fa-shield-alt"></i> Tu información está segura. No compartiremos tu email con
                        terceros.
                    </div>
                </div>
            </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo date('Y'); ?> Periodismo UTB - Universidad Técnica de Babahoyo. Todos los derechos
                    reservados.</p>
